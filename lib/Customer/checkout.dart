...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Future<void> _placeOrder() async {
    ...
    if (_transactionIdController.text.isEmpty) {
      setState(() => _errorMessage = 'Please enter your transaction ID.');
      return;
    }
      ...
      body: _isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildTextFormField(_transactionIdController, 'Bkash Transaction ID', showAlertButton: true),
            const SizedBox(height: 16),
            Text(
              'Order Summary',
              style: Theme.of(context).textTheme.titleLarge?.copyWith(
  ...
  Widget _buildTextFormField(TextEditingController controller, String labelText,
      {TextInputType? keyboardType, int maxLines = 1, bool showAlertButton = false}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        if (!showAlertButton)
          TextFormField(
            ...
            decoration: InputDecoration(
              labelText: labelText,
              labelStyle: const TextStyle(color: Color.fromRGBO(96, 81, 81, 1.0)),
        ...
        if (showAlertButton)
          Row(
            children: [
              ...
              IconButton(
                icon: const Icon(Icons.question_mark_outlined, color: Color.fromRGBO(96, 81, 81, 1.0)),
                onPressed: () {
                  showDialog(
                    context: context,
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: const Text('Send money to Bkash: 01646884961'),
                        actions: [
                          TextButton(
                            onPressed: () {
...
//             const SizedBox(height: 16),
//
//            _buildTextFormField(_transactionIdController, 'Bkash Transaction ID'),
//             const SizedBox(height: 16),
//
//             Text(
//               'Order Summary',
